...
public final class ABCDGuesser1 {
    ...
    private static double getApproximation(double w, double x, double y,
        ...
        //declaring loop numbers for the four loops
        int i;
        int j;
        int k;
        int l;
        ...
        //declaring initial loop-variable
        i = 0;
        while (i < nums.length) {
            ...
            //adding 1 to i to keep the loop going
            i++;
            //declaring the inner loop-variable. This is needed because if you
            //just declare them outside of the loop, it will basically only run
            //once, and not all scenarios will be tested
            j = 0;
            while (j < nums.length) {
                ...
                while (k < nums.length) {
                    ...
                    l = 0;
                    while (l < nums.length) {
                        //getting the final number needed for the complete de Jager
                        //formula
